...
export class theexpanseSystemItem extends Item {
    ...
    get hasFatigue() {
        if (this.data.type === "power" && this.data.data.useFatigue) {return game.settings.get("theexpanse-system", "useFatigue")};
        return false;
    };
    ...
    prepareBaseData() {
        ...
        if (this.data.img === "icons/svg/item-bag.svg") {
            if (!CONFIG.theexpanseSystem.itemIcons[this.data.type]) this.data.img = "icons/svg/item-bag.svg";
            this.data.img = CONFIG.theexpanseSystem.itemIcons[this.data.type];
        };
        ...
        data.colorScheme = `colorset-${game.settings.get("theexpanse-system", "colorScheme")}`;
    ...
    _preparePower(data) {
        const useFatigue = game.settings.get("theexpanse-system", "useFatigue");
            ...
            switch (rollType) {
                ...
                case "attack":
                    ...
                    if (targets.size > 1) {
                        ...
                        let warning = game.i18n.localize("theexpanse-system.WARNING.selectOnlyOneTarget");
    ...
    chatTemplate = {
        "weapon": "systems/theexpanse-system/templates/sheets/weapon-sheet.hbs",
        "focus": "systems/theexpanse-system/templates/sheets/focus-sheet.hbs",
        "stunts": "systems/theexpanse-system/templates/sheets/stunts-sheet.hbs",
        "talent": "systems/theexpanse-system/templates/sheets/talent-sheet.hbs",
        "equipment": "systems/theexpanse-system/templates/sheets/equipment-sheet.hbs",
        "power": "systems/theexpanse-system/templates/sheets/power-sheet.hbs",
        "relationship": "systems/theexpanse-system/templates/sheets/relationship-sheet.hbs",
        "honorifics": "systems/theexpanse-system/templates/sheets/honorifics-sheet.hbs",
        "membership": "systems/theexpanse-system/templates/sheets/membership-sheet.hbs",
        "shipfeatures": "systems/theexpanse-system/templates/sheets/shipfeatures-sheet.hbs"
    };
    ...
    async showItem(forceSelfRoll = false) {
        ...
        const cardData = {
            ...
            colorScheme: game.settings.get("theexpanse-system", "colorScheme"),
            config: {wealthMode: game.settings.get("theexpanse-system", "wealthType")}
        };
        const chatData = {
            user: game.user.id,
