...
export default class theexpanseSystemVehicleSheet extends ActorSheet {
    // constructor(...args) {
    //     super(...args);
    ...
    static get defaultOptions() {
        return mergeObject(super.defaultOptions, {
            ...
            height: 755,
            resizable: false,
            classes: ["theexpanse-system", "sheet", "vehicle"/*, `colorset-${theexpanseSystem.colorScheme}`*/]
        });
    }
    ...
    _onRollManeuver(event) {
        ...
        const rollData = {
            ...
            actor: user,
            abl: handlingUseAbl,
            flavor: game.i18n.format("theexpanse-system.chatCard.maneuversVehicle", {name: user.name, vehicle: this.actor.name}),
