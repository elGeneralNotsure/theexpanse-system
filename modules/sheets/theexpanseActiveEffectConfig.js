...
export default class theexpanseActiveEffectConfig extends ActiveEffectConfig {

  /** @override */
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["sheet", "active-effect-sheet", "theexpanse-system"],
      template: "systems/theexpanse-system/templates/sheets/theexpanse-active-effect-config.hbs",
      width: 560,
      height: "auto",
...
//   /* ----------------------------------------- */
  ...
  getData(options) {
    ...
    return {
      theexpanseEffects: CONFIG.theexpanseSystem.theexpanseEffectsOptions, // Adding labels and Masks
